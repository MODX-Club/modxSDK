...
modxSDK.tree.BuilderObjectsTree = function(config) {
    ...
    Ext.applyIf(config, {
        ...
        tbar: [{
            ...
            tooltip: {
                text: _('modxsdk_create_new_project')
            },
            ...
            tooltip: {
                text: _('modxsdk_select_existing_project')
            },
            ...
            tooltip: {
                text: _('modxsdk_create_new_package')
            },
